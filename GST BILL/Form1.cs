...
namespace GST_BILL
{
    public partial class Form1 : Form
    {
        ...
        String path = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = D:\OEP\GST BILL\GST BILL\gst.mdf; Integrated Security = True";
        ...
        void bindGST()
        {
            ...
            adapter = new SqlDataAdapter("SELECT gst FROM client ORDER BY gst ASC", con);
        ...
        void bindCompanyName()
        {
            con = new SqlConnection();
            con.ConnectionString = path;
            adapter = new SqlDataAdapter("SELECT companyName FROM client ORDER BY companyName ASC", con);
            DataSet items = new DataSet();
            adapter.Fill(items);
        ...
        private void addClient_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("INSERT INTO client VALUES (@companyName,@address,@gst,@state,@stateCode)", con);
        ...
        private void save_Click(object sender, EventArgs e)
        {
            ...
            if (con.State != ConnectionState.Open)
            {
                ...
                //MessageBox.Show("COUNT: " + count + "   InvoiceNo= " + curInvoiceNo);
                if (count != 0)
                {
                ...
                else
                {
                    ...
                    {
                        curInvoiceNo++;
                        //MessageBox.Show(curInvoiceNo.ToString());
        ...
        private void print_Click_1(object sender, EventArgs e)
        {
            ...
            printDocument.PrintPage += new System.Drawing.Printing.PrintPageEventHandler(CreateBill); //add an event handler that will do the printing
        ...
        public void CreateBill(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int startY = 10;
            int offset = 40;
            graphic.DrawString(loginCompanyName, new Font("Courier New", 18), new SolidBrush(Color.Black), startX, startY);
            graphic.DrawString("GSTIN: " + loginGST, font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("____________________________________________________________________________________", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight + 5; //make the spacing consistent
            graphic.DrawString("Date: " + date.Value.ToString("dd MMM yyyy"), font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("Invoice No.: " + invoiceNo.Value.ToString(), font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + ((int)fontHeight*2); //make the spacing consistent
            graphic.DrawString("Receiver's Details", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("------------------------------------------------------------------------------------", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight + 5; //make the spacing consistent
            graphic.DrawString("Comapany Name: " + b_name.Text, font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("Address: " + b_address.Text, font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("GSTIN: " + b_gst.Text, font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("State: " + b_state.Text, font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("State Code: " + b_code.Text, font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("------------------------------------------------------------------------------------", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight + 20; //make the spacing consistent
            graphic.DrawString("Product Details", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            graphic.DrawString("------------------------------------------------------------------------------------", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight + 5; //make the spacing consistent
            graphic.DrawString("Sr. No.  " + "   Product Name      " + "HSN/ACS   " + "  Quantity  " + "   Rate  " + "Taxable Value (Rs.)   ", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight; //make the spacing consistent
            ...
            for (int i=0; i<5; i++)
            {
                ...
                {
                    graphic.DrawString((i+1).ToString(), font, new SolidBrush(Color.Black), startX, startY + offset);
                    graphic.DrawString(products[i].Text, font, new SolidBrush(Color.Black), startX + 100, startY + offset);
                    graphic.DrawString(hsns[i].Text, font, new SolidBrush(Color.Black), startX + 300, startY + offset);
                    graphic.DrawString(quantities[i].Value.ToString(), font, new SolidBrush(Color.Black), startX + 430, startY + offset);
                    graphic.DrawString(rates[i].Value.ToString(), font, new SolidBrush(Color.Black), startX + 550, startY + offset);
                    graphic.DrawString(values[i].Text, font, new SolidBrush(Color.Black), startX + 650, startY + offset);
                    offset = offset + (int)fontHeight;
                }
            }
            graphic.DrawString("------------------------------------------------------------------------------------", font, new SolidBrush(Color.Black), startX, startY + offset);
            offset = offset + (int)fontHeight + 5;
            graphic.DrawString("Totat Value Before Tax (Rs.)", font, new SolidBrush(Color.Black), startX + 350, startY + offset);
            graphic.DrawString(before_tax_value.Text, font, new SolidBrush(Color.Black), startX + 650, startY + offset);
            offset = offset + (int)fontHeight;
            if(!cgst_value.Text.Equals("0"))
            {
                graphic.DrawString("CGST", font, new SolidBrush(Color.Black), startX + 430, startY + offset);
                graphic.DrawString(cgst_value.Text, font, new SolidBrush(Color.Black), startX + 500, startY + offset);
                graphic.DrawString(cgst_value.Text, font, new SolidBrush(Color.Black), startX + 650, startY + offset);
                offset = offset + (int)fontHeight;
            }
            if (!sgst_value.Text.Equals("0"))
            {
                graphic.DrawString("SGST", font, new SolidBrush(Color.Black), startX + 430, startY + offset);
                graphic.DrawString(sgst_value.Text, font, new SolidBrush(Color.Black), startX + 500, startY + offset);
                graphic.DrawString(sgst_value.Text, font, new SolidBrush(Color.Black), startX + 650, startY + offset);
                offset = offset + (int)fontHeight;
            }
            if (!igst_value.Text.Equals("0"))
            {
                graphic.DrawString("IGST", font, new SolidBrush(Color.Black), startX + 430, startY + offset);
                graphic.DrawString(igst_value.Text, font, new SolidBrush(Color.Black), startX + 500, startY + offset);
                graphic.DrawString(igst_value.Text, font, new SolidBrush(Color.Black), startX + 650, startY + offset);
                offset = offset + (int)fontHeight;
            }
            graphic.DrawString("Totat Value After Tax (Rs.)", font, new SolidBrush(Color.Black), startX + 350, startY + offset);
            graphic.DrawString(after_tax_value.Text, font, new SolidBrush(Color.Black), startX + 650, startY + offset);
            offset = offset + (int)fontHeight;
